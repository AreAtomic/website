...
export default function ContactSection() {
  return (
    <section
      id='contact'
      className='py-24 px-6 md:px-10 bg-brand-blue-dark text-white'
    >
      <div className='max-w-[1080px] mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-[1fr_1.2fr] gap-12 md:gap-20 items-start'>
          ...
          <div>
            ...
            <h2 className='text-[clamp(28px,3.5vw,44px)] font-extrabold tracking-[-0.03em] text-white leading-[1.15] mb-4'>
              On en parle ?
            </h2>
            <p className='text-[17px] text-white/60 max-w-[400px] leading-[1.6] mb-12'>
              Un projet à cadrer, une feature à développer, une intégration IA —
            ...
            <div className='space-y-7'>
              <div className='flex items-start gap-3.5'>
                ...
                <div>
                  <div className='text-[13px] text-white/50 mb-0.5'>
                    LinkedIn
                  </div>
                  <a
